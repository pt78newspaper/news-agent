...
USER_PROMPT_TEMPLATE = (
    ...
    "   - 'tech' — технологии и наука: космос, физика, биология, медицина, экология, климат, археология, промышленность, техника. ВСЕ научные исследования и открытия (льды Антарктиды, тёмная материя, динозавры, медицина) — это ВСЕГДА 'tech', никогда 'ai';\n"
    "   - 'ai' — ТОЛЬКО если ГЛАВНЫЙ предмет новости — технология искусственного интеллекта: нейросеть, ИИ-модель, ИИ-продукт, применение ИИ. Если ИИ лишь упоминается вскользь или в заголовке, а суть новости в другом (встреча политиков, экономика, наука) — это НЕ 'ai';\n"
