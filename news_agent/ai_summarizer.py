...
USER_PROMPT_TEMPLATE = (
    ...
    "   • «Конфликты и их суть» (category='conflicts') — где конфликт назревает, обостряется или идёт: события, отражающие конфликт, его причина и предмет. События важнее заявлений — заявления не включай (единственное заявление дня выносится отдельной позицией п.2). Слова значимы, когда превращаются в действие: закон, указ, санкции, судебное решение, военная операция, договор. Русско-украинский конфликт и противостояние Россия—Запад сюда НЕ включай — для них есть группа «СВО» ниже.\n"
    "   • «СВО и Россия — Запад» (category='svo') — русско-украинский конфликт и тесно связанное с ним противостояние России и Запада: ход боевых действий, обмены ударами, переговоры и их срыв, поддержка сторон (военная, финансовая, дипломатическая), санкции и другие реальные действия по этой линии. Приоритетная группа — читатель живёт в России, для него это важнее всего. 1–3 события.\n"
